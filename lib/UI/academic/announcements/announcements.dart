...
class AnnouncementListAcadScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => ManageAnnouncement()),
            );
          },
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  onTap: () {
                    // Add navigation to announcement details screen
                  },
                );
              },
            );
